...
export declare class Opcode {
    ...
    static fromBuffer(buf: any): Opcode;
    static fromNumber(num: any): Opcode;
    static fromString(str: any): Opcode;
    toHex(): string;
    toBuffer(): Buffer;
    toNumber(): number;
    toString(): any;
    static smallInt(n: any): Opcode;
    static map: {
        OP_FALSE: number;
        OP_0: number;
        OP_PUSHDATA1: number;
    ...
    static reverseMap: any[];
    static isSmallIntOp(opcode: any): boolean;
    inspect(): string;
}
