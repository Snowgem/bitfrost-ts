...
export class HDPrivateKey {
    ...
    public static VersionEnd = HDPrivateKey.VersionStart + HDPrivateKey.VersionSize;
    ...
    public static ParentFingerPrintEnd = HDPrivateKey.ParentFingerPrintStart + HDPrivateKey.ParentFingerPrintSize;
    public static ChildIndexStart = HDPrivateKey.ParentFingerPrintEnd;
    public static ChildIndexEnd = HDPrivateKey.ChildIndexStart + HDPrivateKey.ChildIndexSize;
    public static ChainCodeStart = HDPrivateKey.ChildIndexEnd;
    public static ChainCodeEnd = HDPrivateKey.ChainCodeStart + HDPrivateKey.ChainCodeSize;
    public static PrivateKeyStart = HDPrivateKey.ChainCodeEnd + 1;
    public static PrivateKeyEnd = HDPrivateKey.PrivateKeyStart + HDPrivateKey.PrivateKeySize;
    public static ChecksumStart = HDPrivateKey.PrivateKeyEnd;
    public static ChecksumEnd = HDPrivateKey.ChecksumStart + HDPrivateKey.CheckSumSize;
     ...
     * @return {Array}
     */
    public static _getDerivationIndexes = function (path) {
     ...
     * @param {boolean?} hardened
     */
    public deriveNonCompliantChild = function (arg, hardened) {
        if (_.isNumber(arg)) {
    ...
    public _deriveWithNumber = function (index, hardened, nonCompliant) {
        ...
        var privateKey = new BitcoreBN(leftPart.add(this.privateKey.toBigNumber()).umod(Point.getN())).toBuffer({
            size: 32
        });
    ...
    public _buildFromJSON = function (arg) {
     ...
     * @return HDPrivateKey
     */
    public static fromSeed = function (hexa, network) {
    ...
    public _calcHDPublicKey = function () {
    ...
    public _buildFromBuffers = function (arg) {
        ...
        var privateKey = new PrivateKey(BitcoreBN.fromBuffer(arg.privateKey), network);
